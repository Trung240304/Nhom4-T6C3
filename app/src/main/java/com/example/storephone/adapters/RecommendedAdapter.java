...
public class RecommendedAdapter extends RecyclerView.Adapter<RecommendedAdapter.ViewHolder> {
    ...
    Context context;
    List<RecommendedModel> list; // Changed type to RecommendedModel

    public RecommendedAdapter(Context context, List<RecommendedModel> list) { // Updated constructor
    ...
    public void onBindViewHolder(@NonNull RecommendedAdapter.ViewHolder holder, int position) {
        Glide.with(context).load(list.get(position).getImg_url()).into(holder.imageView); // Fixed Glide usage
